...
export const openIndexedDb = () => {
	...
	req.onupgradeneeded = function (evt) {
		...
		try {
			let store = evt.currentTarget.result.createObjectStore(Constants.INDEXED_DB_STORE_NAME, {
				keyPath: 'itemKey',
			});
		...
		try {
			let store = evt.currentTarget.result.createObjectStore(Constants.INDEXED_DB_USER_STORE_NAME, {
				keyPath: 'email',
			});
