    ...
    <div className="gift-options-container">
      ...
      <div className="gift-option-wrapper">
        ...
        <label htmlFor="">
          <span
            className={
              selectedRadio === 0 ? "radio-icon selected" : "radio-icon"
            }
            onClick={() => {
          ...
          <div className="gift-option">
            ...
            <p className="desc">
              Standard Shipping <span className="highlight">(FREE)</span>
            </p>
          </div>
        </label>
      </div>
      <div className="gift-option-wrapper">
        ...
        <label htmlFor="">
          <span
            className={
              selectedRadio === 1 ? "radio-icon selected" : "radio-icon"
            }
            onClick={() => {
          ...
          <div className="gift-option">
            ...
            <p className="desc">
              Express Shipping <span className="highlight">($20.00)</span>
            </p>
          </div>
        </label>
      </div>
      <div className="gift-option-wrapper">
        ...
        <label htmlFor="">
          <span
            className={
              selectedRadio === 2 ? "radio-icon selected" : "radio-icon"
            }
            onClick={() => {
          ...
          <div className="gift-option">
            ...
            <p className="desc">
              Priority Shipping <span className="highlight">($30.00)</span>
            </p>
          </div>
        </label>
      </div>
      ...
      <div className="gift-to">
        <FormControlLabel
          ...
          label="This is a gift, add a message."
        />
        {isGift && (
          <div className="gift-info">
            ...
            <div className="row-1">
              ...
              {errors.message && (
                <div className="errr-hint">{errors.message}</div>
              )}
              <p className="notice">
