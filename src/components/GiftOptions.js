	...
	return (
		<div className="gift-options-container">
			...
			<div className="gift-option-wrapper">
				...
				<label htmlFor="">
					<span
						className={selectedRadio === 0 ? 'radio-icon selected' : 'radio-icon'}
						onClick={() => {
			...
			<div className="gift-option-wrapper">
				...
				<label htmlFor="">
					<span
						className={selectedRadio === 1 ? 'radio-icon selected' : 'radio-icon'}
						onClick={() => {
			...
			<div className="gift-option-wrapper">
				...
				<label htmlFor="">
					<span
						className={selectedRadio === 2 ? 'radio-icon selected' : 'radio-icon'}
						onClick={() => {
