          ...
          <div className="payment-container">
            ...
            {openedIcon1 && (
              <div className="payment1-dropdown-container">
                <div className="payment-dropdown">
                  <span>
                    You will be redirected to PayPal to login to your account
                    and return here to complete your order.
                  </span>
            ...
            {openedIcon2 && (
              <div className="payment2-dropdown-container">
                <div className="payment-dropdown">
                  <span>
                    Shop now. Pay Later. You will be redirected to Afterpay to
                    fill out your payment information and then will return here
            ...
            {openedIcon3 && (
              <div className="payment3-dropdown-container">
                <div className="payment-dropdown">
                  <span>
                    You will be redirected to Klarna to fill out your payment
                    information and then will return here to complete your
                    order.
                  </span>
                  <div className="payment-button"></div>
                </div>
