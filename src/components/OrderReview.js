...
export const OrderReview = () => {
    ...
    const titleIcon = (
        <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
             className="checkout-block_summaryIcon__pjlw1" focusable="false" role="img" aria-hidden="true"
             data-testid="icon">
    ...
    const rotateIcon = (
        <svg height="20" width="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
             className="accordionItemToggleIcon-2RhVn" focusable="false" role="presentation" aria-hidden="true">
                        ...
                        <div className="content-container">
                            <div className="delivery-icon">
                                <svg height="24" width="24" fill="none" viewBox="0 0 24 24"
                                     xmlns="http://www.w3.org/2000/svg" focusable="false" role="img" aria-hidden="true">
                                    <path
                                    ...
                                    <path
                                        ...
                                        stroke="currentColor" stroke-width="1.5"></path>
                                    <path d="M15.1 7.623h5.957l2.185 3.264v5.967h-2.327" stroke="currentColor"
                    ...
                    <div className="add">
                        <button>
                            <svg height="24" width="24" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"
                                 className="gift-card-method_icon__EuuMp" focusable="false" role="img"
                                 aria-hidden="true">
                                <path
                    ...
                    <div className="payment-container">
                        <div className="paypal-container">
                            <div className="picture">
                                <svg height="35" width="56" viewBox="0 0 56 35" xmlns="http://www.w3.org/2000/svg"
                                     className="payment-accordion_headingIcon__xcQae" focusable="false" role="img"
                                     aria-labelledby="icon_:rl:" aria-hidden="false"><title
                                    id="icon_:rl:">PayPal</title>
                                    <g fill="none" fill-rule="evenodd">
                                        <rect height="34" width="55" fill="#FFF" rx=".75" stroke="#D5D5D5" x=".5"
                                              y=".5"></rect>
                                    </g>
                                </svg>
                            ...
                            <div className="add-payment-fixed">
                                {fixedIcon}
                            </div>
                            <div className={`add-payment ${openedIcon1 ? '' : 'rotated'}`}
                        ...
                        <div className="afterpay-container">
                            <div className="picture">
                                <svg height="35" width="56" fill="none" viewBox="0 0 56 35"
                                     xmlns="http://www.w3.org/2000/svg"
                                     className="payment-accordion_headingIcon__xcQae" focusable="false" role="img"
                                     aria-labelledby="icon_:r7k:" aria-hidden="false"><title
                                    id="icon_:r7k:">Afterpay</title>
                            ...
                            <div className={`add-payment ${openedIcon2 ? '' : 'rotated'}`}
                        ...
                        {openedIcon2 && (
                            <div className="payment2-dropdown-container">
                                <div className="payment-dropdown">
                                    <span>Shop now. Pay Later. You will be redirected to Afterpay to fill out your payment information and then will return here to complete your order.</span>
                        ...
                        <div className="klarna-container">
                            <div className="picture">
                                <svg height="35" width="56" fill="none" viewBox="0 0 56 35"
                                     xmlns="http://www.w3.org/2000/svg"
                                     className="payment-accordion_headingIcon__xcQae" focusable="false" role="img"
                                     aria-labelledby="icon_:r7n:" aria-hidden="false"><title
                                    id="icon_:r7n:">Klarna</title>
                            ...
                            <div className={`add-payment ${openedIcon3 ? '' : 'rotated'}`}
                        ...
                        {openedIcon3 && (
                            <div className="payment3-dropdown-container">
                                <div className="payment-dropdown">
                                    <span>You will be redirected to Klarna to fill out your payment information and then will return here to complete your order.</span>
                                    <div className="payment-button"></div>
                                </div>
                            </div>
                        )}
                        ...
                        <div className="credit-card-container">
                            <div className="picture">
                                <svg height="32" width="56" viewBox="0 0 48 32" xmlns="http://www.w3.org/2000/svg"
                                     className="payment-accordion_headingIcon__xcQae" focusable="false" role="img"
                                     aria-labelledby="icon_:r7q:" aria-hidden="false"><title id="icon_:r7q:">Credit
                                    card</title>
                                    <g fill="none" fill-rule="evenodd">
                                        <g stroke="currentColor" stroke-width="1.5">
                                            ...
                                            <path
                                                d="M17 10.742V1.91c0-.502.448-.909 1-.909h28c.552 0 1 .407 1 .91v18.18c0 .503-.448.91-1 .91H31"></path>
                            ...
                            <div className={`add-payment ${openedIcon4 ? '' : 'rotated'}`}
