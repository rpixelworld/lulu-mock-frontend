...
const ProductInfo = ({ product, colorIndex, handleColorChange }) => {
  ...
  const addToBag = () => {
    ...
    let item = {
      ...
      size: selectedSize,
      imageUrl:
        product.images[selectedColorIndex].mainCarousel.media.split(" | ")[0],
  ...
  return (
    <div className="productInfo">
      ...
      <h2 className="price">
        {product.price.replace("CAD", "")} <span className="currency">CAD</span>
      </h2>
      ...
      <div className="alert">
        ...
        {only1Left && (
          <div className="only-1-left">Hurry, only a few left!</div>
        )}
        {sizeNotSelected && (
          <div className="out-of-stock">Please select a size.</div>
        )}
      </div>
      ...
      <div className="sizeList">
        {product.sizes && (
          <p>
            <strong>{product.sizes[0].title}</strong> {selectedSize}
          </p>
        )}
        {product.sizes &&
      ...
      <div className="purchase">
        ...
        <div className="pick-up-container">
          ...
          {!isHidden && (
            ...
            >
              This size/colour combination is not available for Buy & Pick-up at
              any stores near you. Try selecting another size, colour or check
              all store inventory.
            </div>
          )}
        </div>
        ...
        <div className="add-to-bag">
          ...
          {outOfStock && (
            <button className="soldout-button">SOLD OUT - NOTIFY ME</button>
          )}
        </div>

        <div className="check-all">
          <span>Check All Store Inventory</span>
        </div>
      </div>
      ...
      <div className="more-infro">
        <div className="four-ways-payment">
          <p>
            4 payments of $17.00 available with
            {/*LOGO of afterpay*/}
            ...
            >
              <svg
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                className="installment-payments_tooltipIcon__5K1qQ"
                focusable="false"
                role="img"
                aria-hidden="true"
              >
            ...
            {visible && (
              <div className="productInfo-tooltip-detail">
                Buy items now and pay later - in 4 payments, with no additional
                fees when you pay on time. <a href="#">Learn more</a>
              </div>
            )}
          </p>
        </div>
        ...
        <div className="heart-review">
          ...
          >
            <div
              style={{ position: "relative", top: "3px", margin: "0 3px 0 0" }}
            >
              <svg
                height="20"
                width="20"
                ...
                focusable="false"
                role="img"
                aria-labelledby="icon_:rq:"
                aria-hidden="false"
              >
                <title id="icon_:rq:">Add to Wish List</title>
                <path
          ...
          >
            ...
            >
              <svg
                ...
                focusable="false"
                role="img"
                aria-labelledby="icon_:rkd:"
                aria-hidden="false"
              >
                <title id="icon_:rkd:">Reviews</title>
                <path
      ...
      <AddToBag
        product={product}
        item={newAddedItem}
        isOpen={toOpenAddToBagDialog}
        handleClose={closeAddToBagDialog}
      />
    </div>
  );
};
