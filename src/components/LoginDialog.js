      ...
      <DialogContent className="login-dialog">
        <div>
          ...
          >
            <div className="field-container">
              <section className="email">
                ...
                {errors.email && (
                  <div className="errr-hint">{errors.email}</div>
                )}
              </section>
              <section className="password">
                ...
                {errors.password && (
                  <div className="errr-hint">{errors.password}</div>
                )}
              </section>
            </div>
          ...
          <p className="term">
            ...
            acknowledge the <a href="">Privacy Policy</a>. California consumers,
            see our <a href="">Notice of Financial</a> <a href="">Incentives</a>
            .
          </p>
        </div>
      </DialogContent>
