		...
		<div className="order-summary">
			<div className="summary-title">
				...
				<div className="summary-accordion">
					...
					<span className="summary-price title-price">${shoppingCart.totalCost}.00</span>
				</div>
			</div>
			<hr />
			{isOPen && (
			...
			<div className="summary-final">
				<div className="final-list">
					<span>Subtotal</span>
					<span className="summary-price">${shoppingCart.totalCost}.00</span>
				</div>
				<div className="final-list">
					<span>Shipping</span>
			...
			<div className="totalPrice">
				...
				<div>
					CAD <span>$</span>
					{(shoppingCart.totalCost + shippingFee + (shoppingCart.totalCost+shippingFee) * taxRate).toFixed(2)}
				</div>
			</div>
		</div>
	);
