	...
	return <div className="account-addresses">
		...
		<section className='detail'>
			...
			<div className='content-section'>
				{userInfo && userInfo.shippingAddresses && userInfo.shippingAddresses.length &&
				...
				<><div className="one-address">
					<div className="content">
						...
						<div className="value">{address.city}, {address.province} {address.postalCode}, {address.countryCode}</div>
