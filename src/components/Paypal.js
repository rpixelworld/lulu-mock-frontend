...
export const Paypal = () => {
  ...
  const paypalIntegrate = (paypal, PaymentSuccess) => {
    return {
      ...
      client: {
        sandbox:
          "AT00CBFees-dWFZkvRZIdRoC-HcSBflw-Bi2e7S1Y1mCGOlY46BUkBEOTElGDUFwfPEuyy9afsitY7xF",
        production:
          "AWy7L0BwPpJU1qoh9hNZiR9-sadMHUpnOhlRbTw9ha-4LOhB9y4biARxSpBnk1KjbaXEHCnv1pBhumgI",
      },
      ...
      payment: (data, actions) => {
        return actions.payment.create({
          transactions: [
            {
              ...
              description:
                "Mark2win Full Stack Developer Bootcamp Ultimate version",
          ...
          note_to_payer:
            "Contact us markxu@mark2win.com for any questions on your order.",
        });
      },
      // Execute the payment
