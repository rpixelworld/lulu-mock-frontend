...
const likedIcon = (
  <svg fill="#000000" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_iconCarrier">
      <g>
        <path d="M1,15h1.8V6H1Zm12.6-9.38H10L10.64,4a3.31,3.31,0,0,0,.21-1.76A2.72,2.72,0,0,0,10.21.87,2.77,2.77,0,0,0,9.54.31,1.17,1.17,0,0,0,8.65,0,1,1,0,0,0,8,.66c-.11.29-.22.59-.34.88l-.57,1.4L4,6v9h7.11a1.82,1.82,0,0,0,1.61-1l1.94-3.68A3,3,0,0,0,15,8.94V7.07A1.42,1.42,0,0,0,13.61,5.62Z"></path>
      </g>
    </g>
  </svg>
);
  ...
  const handleRatingChange = useCallback(
    (selectedRatings = []) => {
      if (selectedRatings.length === 0) {
        ...
        setDisplayedReviews(
          reviewsData.slice(0, (currentPage + 1) * reviewsPerPage),
        );
      } else {
        ...
        setDisplayedReviews(
          filtered.slice(0, (currentPage + 1) * reviewsPerPage),
        );
      }
    },
      ...
      <div className="reviews-header">
        <div className="reviews-header_container">
          ...
          <div className="reviews-header_average-rating-container">
            ...
            <div className="reviews-header-total-reviews">
              Based on 21 Reviews
            </div>
          </div>
            ...
            <div className="reviews-header-fitRange">
              ...
              <div className="reviews-header-box-container">
                <div className="reviews-header-tooltip">
                  ...
                  <span
                    aria-hidden="true"
                    className="review-header-tooltipText"
                  >
                    Small
                  </span>
                </div>
      ...
      <div className="reviews-containerRoot">
        ...
        <div className="reviews-containerReviews">
          <div className="reviews-section-subheader">
            <div className="review-container-subHeader">
            ...
            {displayedReviews.map((review) => (
              <div className="main-container" key={review.id}>
                <div className="main-user">
                  ...
                  <div className="time">
                    {calculateDaysAgo(review.date)} days ago
                  </div>
                </div>
                ...
                <div className="main-card-component">
                  <div className="liked-button">{UnlikedIcon}</div>
                  <div className="leave-a-comment">
                    ...
                    <div className="comment-word">Leave a comment</div>
                  </div>
                </div>
              </div>
            ))}
