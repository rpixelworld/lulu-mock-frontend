...
export const Reviews = () => {
	...
	const handleLoadMore = () => {
		...
		setDisplayedReviews(prevReviews => [...prevReviews, ...reviewsData.slice(startIndex, endIndex)]);
						...
						<div className="reviews-header-fitRange">
							...
							<div className="reviews-header-box-container">
								<div className="reviews-header-tooltip">
									...
									<span aria-hidden="true" className="review-header-tooltipText">
										Small
									</span>
								</div>
								<div className="reviews-header-tooltip">
							...
							<div className="main-container" key={review.id}>
								<div className="main-user">
									<div className="user-image">
										<div className="name">{review.username.slice(0, 1).toUpperCase()}</div>
									</div>
