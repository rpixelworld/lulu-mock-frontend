...
export const AddToBag = ({product, item, isOpen, handleClose}) => {
    ...
    useEffect(() => {
        ...
        if(productList && productList.length>0){
            ...
            for(let i=0; i<4; i++) {
                ...
                if (prod.productId!==product.productId && !goeswellwith.includes(p => p.productId === prod.productId)) {
    ...
    return (
        <Dialog open={isOpen} scroll='body' sx={{ '& .MuiDialog-paper': { maxWidth: '950px' } }}   >
            <DialogContent>
        ...
        <div className="addtobag-container">
            ...
            <div className="first-row">
                {random===0 && <div className="add-to-your-bag">Added To Your Bag</div>}
                {random===1 && <div className="add-to-your-bag">Nice Pick!</div>}
                {random===2 && <div className="add-to-your-bag">Expect Compliments</div>}
                {random===3 && <div className="add-to-your-bag">We Love It Too</div>}
                <ShoppingBagOutlinedIcon className="bag-icon"/>
                <div className="bag-item">{shoppingCart.total} Items</div>
                <div className="close-icon"><CloseOutlinedIcon onClick={handleClose}/>
                </div>
            </div>
            ...
            <div className="second-row">
                ...
                <div className="col-2">
                    ...
                    <button onClick={()=>{navigate('/shop/cart')}}>VIEW BAG & CHECKOUT</button>
                    <div className="continue">
                        <div className="continue-shopping" onClick={handleClose}>CONTINUE SHOPPING</div>
            ...
            <div className="third-row">
                ...
                <div className="addtobag-swiper-container">
                    <ul className="addtobag-swiper-wrapper">
                        ...
                        {goeswellwith && goeswellwith.map((product) =>
                            <ProductAddToBag key={product.productId} product={product} />
                        )}
                    </ul>
                </div>
            </div>
