	...
	return (
		<>
			<div className="productlist-container">
				...
				<div
					className="row"
					style={{ display: 'flex', justifyContent: 'start', marginBottom: '20px', marginLeft: '1px' }}
				>
					<img width={200} src={uploadedImg} alt="" />
				</div>
				{productList && Array.isArray(productList) > 0 && (
					<div className="row" style={{ marginBottom: '5px', marginLeft: '1px' }}>
						<span style={{ fontSize: '18px', fontWeight: '600' }}>
							We found {productList.length} similar items
						</span>
					</div>
				)}
				<div className="row">
