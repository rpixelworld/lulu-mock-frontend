...
export const RemoveConfirmDialog = ({isOpen, itemKey, handleRemove, handleClose})=> {
    ...
    return <Dialog fullScreen={false} open={isOpen}>
        <DialogContent className='remove-confirm-dialog-container'>
            ...
            <button type='button' className='confirm'
                    onClick={()=>{handleRemove(itemKey)}}>yes, remove this item</button>
            <div className='no'><span onClick={handleClose}>No, keep this item</span></div>
        </DialogContent>
    </Dialog>
}