		...
		<div className='account-container'>
			...
			<div className='account-main-container'>
				<div className="left-nav">
					<Link className={`nav-item ${location.pathname.includes('profile')?'active':''}`}
						  to="/account/profile">Profile</Link>
					<Link className={`nav-item ${location.pathname.includes('shipping-addresses')?'active':''}`}
						  to="/account/shipping-addresses">Shipping Addresses</Link>
					<Link className={`nav-item ${location.pathname.includes('purchase-history')?'active':''}`}
						  to="/account/purchase-history">Purchase History</Link>
				</div>
