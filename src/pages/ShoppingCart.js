			...
			{shoppingCart && shoppingCart.items && shoppingCart.items.length > 0 && (
				<>
					...
					<div className="cart-container">
						<h2>
							My Bag <span>({shoppingCart.total} Items)</span>
						</h2>
					...
					<div className="summary-container">
						...
						<div className="row">
							<div className="label">
								...
								<HtmlTooltip
									positon="top"
									content="We offer Free Standard Shipping on all orders within Canada. Shipping can be expedited in checkout."
								/>
							</div>
						...
						<div className="row">
							<div className="label">
								...
								<HtmlTooltip
									positon="top"
									content="Taxes are based on your shipping location’s provincial and local sales tax."
								/>
							</div>
						...
						<div className="payment">
							...
							<HtmlTooltip
								...
								content={
									<>
										Buy items now and pay later - in 4 payments. <a href="#">Learn more</a>
									</>
								}
							/>
						</div>
